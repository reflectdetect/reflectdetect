...
# 
# Key analyses:
# - Perform ANOVA and post hoc tests to assess significant differences in 
...
# 
# Francis, L., Geissler, L., Okole, N., Stachniss, C., Gipp, B., Heim, R. HJ. (2025). 
# ReflectDetect: A software tool for AprilTag-Guided In-Flight Radiometric 
# Calibration for UAV Optical Data. (accepted) SoftwareX.
# 
...
# Load data
sampling_points <- "20250310_sample_data.gpkg"
